...
python ../cgenff_charmm2gmx_py3_nx2.py lig lig_fix.mol2 lig_fix.str ../charmm36-jul2022.ff
conda deactivate
...
#修改complex.gro:
perl ../addatom.pl lig.gro rec_processed.gro
...
#比如75-100在mmpbsa_charm.in里面改
mpirun -np 10 gmx_MMPBSA MPI -O -i ../../mmpbsa_amber.in -cs ../md_0_10.tpr -ci ../index.ndx -cg 1 13 -ct ../md_0_10_center.xtc -cp ../topol.top
